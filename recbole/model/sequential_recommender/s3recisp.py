...
class S3RecISP(SequentialRecommender):
    r"""
    ...
    def __init__(self, config, dataset):
        super(S3RecISP, self).__init__(config, dataset)
    ...
    def pretrain(
        self, masked_item_sequence, pos_items, neg_items, masked_segment_sequence, pos_segment, neg_segment
    ):
        ...
        pretrain_loss = self.mip_weight * mip_loss \
    ...
    def reconstruct_pretrain_data(self, item_seq, item_seq_len):
        ...
        return masked_item_sequence, pos_items, neg_items, \
    ...
    def calculate_loss(self, interaction):
        ...
        if self.train_stage == 'pretrain':
            ...
            loss = self.pretrain(
                masked_item_sequence, pos_items, neg_items, masked_segment_sequence, pos_segment, neg_segment
            )
        # finetune
        else:
